...
public class UserController {
	...
	@ResponseBody
	public String register(@ModelAttribute UserDTO userDTO, HttpServletRequest request) {

		if (userDTO.getProfileOriginal() == null || userDTO.getProfileUUID() == null
				|| userDTO.getProfileUUID().isEmpty()) {
